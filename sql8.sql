...
Commande en ligne de commande linux : SELECT languages.name AS language, frameworks.name AS framework FROM frameworks RIGHT JOIN languages ON frameworks.languagesId = languages.id;
...
Commande en ligne de commande linux : SELECT languages.name AS language, frameworks.name AS framework FROM frameworks INNER JOIN languages ON frameworks.languagesId = languages.id;
...
Commande en ligne de commande linux : SELECT languages.name, COUNT(frameworks.id) FROM languages INNER JOIN frameworks ON languages.id = frameworks.languagesId GROUP BY languages.name;
...
Commande en ligne de commande linux : SELECT languages.name, COUNT(frameworks.id) FROM languages INNER JOIN frameworks ON languages.id = frameworks.languagesId GROUP BY languages.name HAVING COUNT(frameworks.id) > 4;
